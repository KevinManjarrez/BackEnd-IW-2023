...
//==========================================GET ONE BY ID===========================================================S
export const GetOneOrderByID = async (
  IdInstitutoOK,
  IdNegocioOK,
  IdOrdenOK
) => {
...
export const AddOneOrder = async (newOrden) => {
  ...
  try {
    ...
    const addedOrder = await ordersModel
      .insertMany(newOrden, { order: true })
      .then((order) => {
        if (!order) {
...
export const UpdateOneOrder = async (
  ...
  try {
    ...
    const updatedOrden = await ordersModel.findOneAndUpdate(
      {
        IdInstitutoOK: IdInstitutoOK,
        IdNegocioOK: IdNegocioOK,
        IdOrdenOK: IdOrdenOK,
...
export const DeleteOneOrder = async (IdInstitutoOK, IdNegocioOK, IdOrdenOK) => {
  ...
  try {
    ...
    const result = await ordersModel.deleteOne({
      IdInstitutoOK: IdInstitutoOK,
      IdNegocioOK: IdNegocioOK,
      IdOrdenOK: IdOrdenOK,
    });
