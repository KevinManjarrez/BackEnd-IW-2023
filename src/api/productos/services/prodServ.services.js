...
import ProdServ from '../../productos/models/productos';
...
export const GetOneProdServ = async (params) => {
	//console.log("productId 1111 :",productId)
	let bitacora = BITACORA();
...
export const PatchOneProdServ = async (params, updateData) => {
	let bitacora = BITACORA();
	//let response = PatchOneProdServMethod(bitacora, params, updateData);
...
//FIC: no se esta usando.
export const PatchOneProdServMethod = async (bitacora, params, updateData) => {
	let data = DATA();
	try {
